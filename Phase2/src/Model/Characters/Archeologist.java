 ...
 */
public class Archeologist implements Character{
    ...
    /**
     * <b>Constructor</b> Constructs a new archeologist card with character name, a player that belongs to, a state and a color
     * <b>Postcondition:</b> A new archeologist card with name,player,color and state has been constructed
     * @param player
     * @param color
     */
    public Archeologist(Player player, String color){
        this.Character = "Archeologist";
        this.player1 = player;
    ...
    /**
     * <b>Transformer</b> Uses the card according to it's use. Takes two areas as parameters.
    ...
    public void use(String area1, int i){
        ...
        if(this.getUsed() == true || area1 == this.player1.getLastArea()){
            return;
        }
