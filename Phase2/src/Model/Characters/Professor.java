...
public class Professor implements Character{
    ...
    /**
     * <b>Constructor</b> Constructs a new Professor card with character name, a player that belongs to, a state and a color
     * <b>Postcondition:</b> A new Professor card with name,player,color and state has been constructed
     * @param player
     * @param color
     */
    public Professor(Player player, String color){
    ...
    public void use(String area1, int i){
        ...
        this.player1.setTileNumber(currentTiles + 1);
